...
ps_match <- function(treatment, control, seed, i) {
  ...
  candidates <- read_rds(glue::glue("{write_dir}/model_{treatment}_{control}_{i}.rds"))
  ...
  write_rds(
    matches,
    glue::glue("{write_dir}/matches_{treatment}_{control}_{i}.rds")
  )
