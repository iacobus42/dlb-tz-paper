...
for (i in 0:3) {
  ...
  write_rds(
    tz_tam_full,
    glue::glue("{write_dir}/model_tz_tam_{i}.rds"))
  write_rds(
    tz_5ari_full,
    glue::glue("{write_dir}/model_tz_5ari_{i}.rds"))
  write_rds(
    tam_5ari_full,
    glue::glue("{write_dir}/model_tam_5ari_{i}.rds"))
}
```
