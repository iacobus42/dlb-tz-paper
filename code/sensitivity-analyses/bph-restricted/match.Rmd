...
```{r def-match-cpp}
sourceCpp("~/projects/archive/pd-preprint/match.cpp")
```
...
ps_match <- function(treatment, control, seed) {
  log_path <- glue::glue("~/{treatment}_{control}_bph_only.txt")
  ...
  candidates <- read_rds(glue::glue("{match_dir}/{treatment}_{control}_bph_only.rds"))
  ...
  write_rds(
    matches,
    glue::glue("{match_dir}/matches_{treatment}_{control}_bph_only.rds")
  )
  cat(
...
clusterEvalQ(cl, sourceCpp("~/projects/archive/pd-preprint/match.cpp"))
