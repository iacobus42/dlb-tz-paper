...
ps_match <- function(treatment, control, two_rx, seed) {
  if (two_rx) {
    log_path <- glue::glue("/Shared/lss_jsimmeri/LBD/{treatment}_{control}_2rx.txt")
  } else {
    log_path <- glue::glue("/Shared/lss_jsimmeri/LBD/{treatment}_{control}_any.txt")
  }  
  ...
  if (two_rx) {
    match_path <- glue::glue("/Shared/lss_jsimmeri/LBD/matches_{treatment}_{control}_2rx.rds")
  } else {
    match_path <- glue::glue("/Shared/lss_jsimmeri/LBD/matches_{treatment}_{control}_any.rds")
  }
