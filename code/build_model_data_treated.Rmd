...
```{r data-load}
enrollments <- read_rds("/Shared/lss_jsimmeri/LBD/candidate_treated.rds")
demographics <- read_rds("/Shared/lss_jsimmeri/LBD/treated_demographics.rds")
```
...
reduce_dx <- function(args) {
  ...
  write_rds(first_dx, glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}.rds"))
  write_rds(inpatient_volume, glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_inpatient.rds"))
  write_rds(outpatient_volume, glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_outpatient.rds"))
  write_rds(outpatient_dx_volume, glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_outpatient_dx.rds"))
  write_rds(outpatient_ndx, glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_outpatient_ndx.rds"))
...
for (source in c("ccae", "mdcr")) {
  for (year in stringr::str_pad(1:17, width = 2, pad = "0")) {
    dx_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}.rds"))
    inpatient_volume_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_inpatient.rds"))
    outpatient_volume_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_outpatient.rds"))
    outpatient_dx_volume_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_outpatient_dx.rds"))
    ndx_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri/LBD/{source}_{year}_outpatient_ndx.rds"))
    i <- i + 1
    p$tick()
  }
}
...
write_rds(model_data,
          "/Shared/lss_jsimmeri/LBD/treated_model_data.rds")
```
