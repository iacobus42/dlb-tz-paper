...
demos <- read_rds("/Shared/lss_jsimmeri/LBD/treated_demographics.rds")
study_enrollments <- read_rds("/Shared/lss_jsimmeri/LBD/treated_enrollments.rds")
```
...
write_rds(final_cohort,
          "/Shared/lss_jsimmeri/LBD/candidate_treated.rds")
```
