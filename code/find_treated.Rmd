...
```{r data-save}
write_rds(rx_events, "/Shared/lss_jsimmeri/LBD/treated_rx_events.rds")
write_rds(ever_users, "/Shared/lss_jsimmeri/LBD/ever_users.rds")
```
