...
matches <- read_rds(glue::glue("/{shared_dir}/lss_jsimmeri/LBD/matches_tam_5ari_2rx.rds"))
```
...
```{r}
ps <- read_rds(glue::glue("/{shared_dir}/lss_jsimmeri/LBD/model_tam_5ari_2rx.rds"))
bind_rows(
  model_data %>%
