...
matches <- read_rds(glue::glue("/{shared_dir}/lss_jsimmeri/LBD/matches_tz_5ari_2rx.rds"))
```
...
```{r}
ps <- read_rds(glue::glue("/{shared_dir}/lss_jsimmeri/LBD/model_tz_5ari_2rx.rds"))
bind_rows(
  model_data %>%
  ...
  labs(x = "Probability of Treatment with 5ari", 
       y = "Density",
