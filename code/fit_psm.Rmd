...
```{r load-model-data}
treated <- read_rds("/Shared/lss_jsimmeri/LBD/treated_model_data.rds")
```
...
### TZ/DZ/AZ vs...
```{r fit-psm-tz-tam}
model_tz_tam_2rx <- fit_gam_model(tz_tam_2rx, ps_full)
model_tz_tam_any <- fit_gam_model(tz_tam_any, ps_full)
```

```{r fit-psm-tz-5ari}
model_tz_5ari_2rx <- fit_gam_model(tz_5ari_2rx, ps_full)
model_tz_5ari_any <- fit_gam_model(tz_5ari_any, ps_full)
```

### Tamsulosin vs...
```{r fit-psm-tam-5ari}
model_tam_5ari_2rx <- fit_gam_model(tam_5ari_2rx, ps_full)
model_tam_5ari_any <- fit_gam_model(tam_5ari_any, ps_full)
```
...
write_rds(
  model_tz_tam_2rx,
  "/Shared/lss_jsimmeri/LBD/model_tz_tam_2rx.rds")
write_rds(
  model_tz_5ari_2rx,
  "/Shared/lss_jsimmeri/LBD/model_tz_5ari_2rx.rds")
write_rds(
  model_tam_5ari_2rx,
  "/Shared/lss_jsimmeri/LBD/model_tam_5ari_2rx.rds")

write_rds(
  model_tz_tam_any,
  "/Shared/lss_jsimmeri/LBD/model_tz_tam_any.rds")
write_rds(
  model_tz_5ari_any,
  "/Shared/lss_jsimmeri/LBD/model_tz_5ari_any.rds")
write_rds(
  model_tam_5ari_any,
  "/Shared/lss_jsimmeri/LBD/model_tam_5ari_any.rds")
```
