...
```{r data-write}
write_rds(demographics, "/Shared/lss_jsimmeri/LBD/treated_demographics.rds")
write_rds(collapsed_enrollments, "/Shared/lss_jsimmeri/LBD/treated_enrollments.rds")
```
